...
\begin{frame}{2.3 Bayes --- worked example}
  \footnotesize
  \textbf{Setup.}\ Good is high quality with prior $P(H)=\tfrac13$.
  Signal: with high quality, $P(S\mid H)=\tfrac45$;
  with low quality, $P(S\mid L)=\tfrac15$.
  Observe $S$. What is $P(H\mid S)$?

  \medskip
  \[
    P(S)
    =\tfrac45\cdot\tfrac13+\tfrac15\cdot\tfrac23
    =\tfrac25,
    \qquad
    P(H\mid S)
    =\frac{(\tfrac45)(\tfrac13)}{\tfrac25}
    =\tfrac23.
  \]

  \medskip
  Prior $\tfrac13$ $\to$ posterior $\tfrac23$: a favorable signal revises beliefs upward.
\end{frame}
